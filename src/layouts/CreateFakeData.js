...
const createFakeData = async () => {
  try {
      ...
      await contractInstance.signup('Merchant 2', merchant2, true, 3, 'MCN2', 'https://zos.alipayobjects.com/rmsportal/dNuvNrtqUztHCwM.png', { from: ZERO_ACCOUNT, gas: 1000000 })
      await contractInstance.signup('User 3', user3, false, 0, 'null', 'null', { from: ZERO_ACCOUNT, gas: 1000000 })
      await contractInstance.signup('Merchant 3', merchant3, true, 4, 'MCN3', 'https://zos.alipayobjects.com/rmsportal/dNuvNrtqUztHCwM.png', { from: ZERO_ACCOUNT, gas: 1000000 })
      await contractInstance.signup('User 4', user4, false, 0, 'null', 'null', { from: ZERO_ACCOUNT, gas: 1000000 })
      await contractInstance.signup('Merchant 4', merchant4, true, 5, 'MCN4', 'https://zos.alipayobjects.com/rmsportal/dNuvNrtqUztHCwM.png', { from: ZERO_ACCOUNT, gas: 1000000 })
      await contractInstance.signup('User 5', user5, false, 0, 'null', 'null', { from: ZERO_ACCOUNT, gas: 1000000 })
      await contractInstance.signup('Merchant 5', merchant5, true, 6, 'MCN5', 'https://zos.alipayobjects.com/rmsportal/dNuvNrtqUztHCwM.png', { from: ZERO_ACCOUNT, gas: 1000000 })
